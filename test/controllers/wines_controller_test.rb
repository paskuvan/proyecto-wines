...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { age: @wine.age, desc: @wine.desc, picture: @wine.picture, product: @wine.product } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { age: @wine.age, desc: @wine.desc, picture: @wine.picture, product: @wine.product } }
